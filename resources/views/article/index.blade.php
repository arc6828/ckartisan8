                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Title</th><th>Link</th><th>Guid</th><th>Category</th><th>Creator</th><th>PubDate</th><th>ContentEncoded</th><th>Image Url</th><th>First Paragraph</th><th>Credit</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($article as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->title }}</td><td>{{ $item->link }}</td><td>{{ $item->guid }}</td><td>{{ $item->category }}</td><td>{{ $item->creator }}</td><td>{{ $item->pubDate }}</td><td>{{ $item->contentEncoded }}</td><td>{{ $item->image_url }}</td><td>{{ $item->first_paragraph }}</td><td>{{ $item->credit }}</td>
                                        <td>
